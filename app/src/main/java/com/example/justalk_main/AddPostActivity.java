...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //validate if we came here to update post i.e. from Adapter post
            ...
            case CAMERA_REQUEST_CODE:{
                if(grantResults.length> 0){
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        //both camera nd storage permission denied
                        Toast.makeText(this,"camara & storage both permissions are necessary...",Toast.LENGTH_SHORT).show();
